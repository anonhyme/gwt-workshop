...
public class Upload implements Exportable {
  ...
  public Upload(JavaScriptObject prop) {
    ...
    if ("browser".equals(choose)) {
      Uploader.setFileInputType(FileInputType.BROWSER_INPUT);
    } else if ("label".equals(choose)) {
        Uploader.setFileInputType(FileInputType.LABEL);
    } else if ("anchor".equals(choose)) {
      Uploader.setFileInputType(FileInputType.ANCHOR);
    } else {  
      Uploader.setFileInputType(FileInputType.BUTTON);
    }
